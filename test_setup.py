...
def test_openai_client():
    ...
    try:
        ...
        if not api_key or api_key == 'your_openai_api_key_here':
            ...
            print("   Set your API key in .env file to test OpenAI connectivity")
            return False
        ...
        print("   To test API connectivity, uncomment the lines below and run again")
        # models = client.models.list()
        # print(f"✅ Connected to OpenAI API - {len(models.data)} models available")
